...
LAB37:    t299 = (t0 + 9248);
    ...
    *((unsigned int *)t309) = (t311 | t305);
    xsi_driver_vfirst_trans(t299, 0, 4);
    t312 = (t0 + 8880);
    *((int *)t312) = 1;
...
LAB67:    memcpy(t120, t209, 8);

LAB68:    goto LAB32;

LAB33:    xsi_vlog_unsigned_bit_combine(t3, 32, t115, 32, t120, 32);
    goto LAB37;
...
LAB74:    memcpy(t250, t213, 8);

LAB75:    memset(t210, 0, 8);
    t282 = (t250 + 4);
...
LAB96:    if (*((unsigned int *)t210) > 0)
        goto LAB97;

LAB98:    memcpy(t209, t298, 8);

LAB99:    goto LAB63;

LAB64:    xsi_vlog_unsigned_bit_combine(t120, 32, t204, 32, t209, 32);
    goto LAB68;

LAB66:    memcpy(t120, t204, 8);
    goto LAB68;
...
LAB81:    if (*((unsigned int *)t243) != 0)
        goto LAB82;

LAB83:    t251 = *((unsigned int *)t213);
...
LAB95:    xsi_vlog_unsigned_bit_combine(t209, 32, t293, 32, t298, 32);
    goto LAB99;

LAB97:    memcpy(t209, t293, 8);
    goto LAB99;
...
extern void work_m_00000000001183306600_2273557827_init()
{
	static char *pe[] = {(void *)Cont_54_0,(void *)Cont_58_1,(void *)Cont_63_2,(void *)Cont_68_3,(void *)Cont_85_4,(void *)Cont_90_5,(void *)Cont_105_6};
	xsi_register_didat("work_m_00000000001183306600_2273557827", "isim/mips.exe.sim/work/m_00000000001183306600_2273557827.didat");
